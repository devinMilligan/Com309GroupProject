...
public class MapsActivityAdmin extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerInfoWindowAdapterAdmin markerInfoWindowAdapterAdmin = new MarkerInfoWindowAdapterAdmin(getApplicationContext());
        googleMap.setInfoWindowAdapter(markerInfoWindowAdapterAdmin);
